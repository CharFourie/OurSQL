...
if(isset($_POST['sign_up']))
    {
        ...
        if($check==1)
        {
            echo "<script>alert('Email is already registered, please use another!')</script>";
            exit();
        }
        ...
        else
        {
            ...
            values ('$name','$pass','$email','$country','$gender','$b_day','images/default.jpg',NOW(),NOW(),'$status','$posts')";
